...
type SidebarContentProps = {
  ...
  superAdmin: { fullName: string } | null;
  dispatch: AppDispatch;
};

function SidebarContent({ pathname, setMobileOpen, superAdmin, dispatch }: SidebarContentProps) {
  return (
      ...
      <div className="p-3 border-t border-[color:var(--adm-border)]">
        <div className="flex items-center gap-3 px-2 py-2">
          ...
          <div className="min-w-0 flex-1">
            <div className="text-sm font-medium text-[var(--adm-fg)] truncate">
...
export default function Sidebar() {
  ...
  const superAdmin = useAppSelector((state) => state.auth.superAdmin);
